...
static retreat_state_e next_retreat_state(const struct state_retreat_data *data)
{
    ...
    case LINE_FRONT_LEFT:
        if (object_at_right(&data->common->object) || object_at_front(&data->common->object)) {
            return RETREAT_STATE_ALIGN_RIGHT;
        } else if (object_at_left(&data->common->object)) {
    ...
    case LINE_FRONT_RIGHT:
        if (object_at_left(&data->common->object) || object_at_front(&data->common->object)) {
            return RETREAT_STATE_ALIGN_LEFT;
        } else if (object_at_right(&data->common->object)) {
            return RETREAT_STATE_ALIGN_RIGHT;
        } else {
            return RETREAT_STATE_REVERSE;
        }
    ...
    case LINE_BACK_RIGHT:
        ...
        break;
    case LINE_FRONT:
        if (object_at_left(&data->common->object)) {
            return RETREAT_STATE_ALIGN_LEFT;
        } else if (object_at_right(&data->common->object)) {
            return RETREAT_STATE_ALIGN_RIGHT;
        } else {
